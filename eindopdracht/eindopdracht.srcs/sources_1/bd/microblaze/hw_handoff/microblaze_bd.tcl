...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports GPIO_1] [get_bd_intf_pins axi_gpio_2/GPIO]
