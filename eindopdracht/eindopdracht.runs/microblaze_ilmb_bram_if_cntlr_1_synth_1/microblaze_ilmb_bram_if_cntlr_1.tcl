...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Development/PROGH2/eindopdracht/eindopdracht.runs/microblaze_ilmb_bram_if_cntlr_1_synth_1 -new_name microblaze_ilmb_bram_if_cntlr_1 -ip [get_ips microblaze_ilmb_bram_if_cntlr_1]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top microblaze_ilmb_bram_if_cntlr_1 -part xc7a35tcpg236-1 -mode out_of_context
...
set TIME_taken [expr [clock seconds] - $TIME_start]
 ...
 config_ip_cache -add -dcp microblaze_ilmb_bram_if_cntlr_1.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips microblaze_ilmb_bram_if_cntlr_1]
}
