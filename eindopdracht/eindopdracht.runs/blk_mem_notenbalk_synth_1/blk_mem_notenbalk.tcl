...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Development/PROGH2/eindopdracht/eindopdracht.runs/blk_mem_notenbalk_synth_1 -new_name blk_mem_notenbalk -ip [get_ips blk_mem_notenbalk]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top blk_mem_notenbalk -part xc7a35tcpg236-1 -mode out_of_context
...
set_param constraints.enableBinaryConstraints false
 ...
 write_checkpoint -force -noxdef -rename_prefix blk_mem_notenbalk_ blk_mem_notenbalk.dcp

 set ipCachedFiles {}
 write_verilog -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_notenbalk_stub.v
 lappend ipCachedFiles blk_mem_notenbalk_stub.v

 write_vhdl -force -mode synth_stub -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_notenbalk_stub.vhdl
 lappend ipCachedFiles blk_mem_notenbalk_stub.vhdl

 write_verilog -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_notenbalk_sim_netlist.v
 lappend ipCachedFiles blk_mem_notenbalk_sim_netlist.v

 write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ blk_mem_notenbalk_sim_netlist.vhdl
 lappend ipCachedFiles blk_mem_notenbalk_sim_netlist.vhdl
set TIME_taken [expr [clock seconds] - $TIME_start]

 config_ip_cache -add -dcp blk_mem_notenbalk.dcp -move_files $ipCachedFiles -use_project_ipc  -synth_runtime $TIME_taken  -ip [get_ips blk_mem_notenbalk]
}

rename_ref -prefix_all blk_mem_notenbalk_

# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef blk_mem_notenbalk.dcp
